...
function AboutUs() {
    ...
    return (
        <div className='bg-white'>
            ...
            <div>
                <h2 className="mb-4 text-2xl font-bold text-blue-900 mt-20 ml-56">
            ...
            <div className='flex flex-row  justify-evenly mt-14 ml-24 '>
                {/* first card */}
                <div className='mb-10'>
                    <a href="#" class="flex flex-col items-center bg-blue-50  rounded-lg shadow md:flex-row md:max-w-xl hover:bg-blue-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 md:h-64">
                        <img class="object-cover w-full  h-96 md:h-64 md:w-48 p-2 rounded-xl shadow-2xl " src={img7} alt="" />
                        <div class="flex flex-col justify-between p-4 leading-normal">
                            ...
                            <a href="https://github.com/ramzi-abulail" aria-current="page" className="px-4 py-2 text-sm font-medium text-center text-white bg-blue-900 border border-blue-800 rounded-lg hover:bg-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-white dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-blue-500 dark:focus:text-white mt-20 ">
                               More About Me 
                            </a>
                        </div>
                    </a>
                ...
                <div className='mb-10'> 
                    <a href="#" class="flex flex-col items-center bg-blue-50  rounded-lg shadow md:flex-row md:max-w-xl hover:bg-blue-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 md:h-64">
                        <img class="object-cover w-full  h-96 md:h-64 md:w-48 p-2 rounded-xl shadow-2xl " src={img9} alt="" />
                        <div class="flex flex-col justify-between p-4 leading-normal">
                            ...
                            <a href="#" aria-current="page" className="px-4 py-2 text-sm font-medium text-center text-white bg-blue-900 border border-blue-800 rounded-lg hover:bg-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-white dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-blue-500 dark:focus:text-white mt-20 ">
                               More About Me 
                            </a>
                        </div>
                    </a>
