        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 ">
          {paginatedServices.map((service) => (
            <div key={service.id} className="border shadow-2xl mb-8 md:h-[300px] text-center rounded-tr-3xl rounded-bl-3xl ">
              <img src={service.photo} alt={service.name} className="w-full h-[200px] rounded-tr-3xl rounded-bl-3xl p-3 text-center" />
              <div className="p-4 font-bold text-xl">
                ...
                <div className="flex justify-center mt-2">
                  <Link
                    ...
                    className="hover:bg-[#5354a8dd] bg-transparent border-2 border-[#5354a8dd] text-[#5354a8dd] translate-x-3 hover:text-white h-9 w-32 text-center rounded-lg pt-1 mr-14 my-2"
                    onClick={handleClick}
                  >
                    Details
                  </Link>
